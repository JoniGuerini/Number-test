...
/** Total de geradores da linha da Comida (para "X/20"). */
export const GENERATORS_TOTAL = 20;

export const PROFILES: Record<string, PlayerProfile> = {
  Yseult: { rankPos: 1, prosperity: 9_820_000, wheat: '4.2M', topGen: 'Dinastia', gens: 20, clan: 'Ordem do Trigo', seasonJoined: 1 },
  Kaelen: { rankPos: 2, prosperity: 8_450_000, wheat: '3.1M', topGen: 'Império', gens: 19, clan: 'Ordem do Trigo', seasonJoined: 1 },
  Bramble: { rankPos: 5, prosperity: 5_600_000, wheat: '1.4M', topGen: 'Reino', gens: 18, clan: 'Vale Dourado', seasonJoined: 2 },
  Mirena: { rankPos: 14, prosperity: 3_200_000, wheat: '820K', topGen: 'Província', gens: 16, clan: 'Vale Dourado', seasonJoined: 2 },
  Petra: { rankPos: 19, prosperity: 2_950_000, wheat: '760K', topGen: 'Metrópole', gens: 15, clan: 'Ordem do Trigo', seasonJoined: 2 },
  Thane: { rankPos: 22, prosperity: 2_700_000, wheat: '690K', topGen: 'Metrópole', gens: 15, clan: 'Ordem do Trigo', seasonJoined: 2 },
  Isolde: { rankPos: 47, prosperity: 1_450_000, wheat: '260K', topGen: 'Cidadela', gens: 13, clan: 'Vale Dourado', seasonJoined: 3 },
  Aldric: { rankPos: 63, prosperity: 1_180_000, wheat: '210K', topGen: 'Comarca', gens: 12, clan: 'Vale Dourado', seasonJoined: 3 },
  Rowan: { rankPos: 88, prosperity: 980_000, wheat: '160K', topGen: 'Feudo', gens: 11, clan: null, seasonJoined: 3 },
  Corvin: { rankPos: 210, prosperity: 420_000, wheat: '52K', topGen: 'Vila', gens: 9, clan: 'Vale Dourado', seasonJoined: 4 },
  Garrick: { rankPos: 305, prosperity: 260_000, wheat: '31K', topGen: 'Aldeia', gens: 8, clan: null, seasonJoined: 4 },
  Doran: { rankPos: 640, prosperity: 90_000, wheat: '6.4K', topGen: 'Feira', gens: 6, clan: null, seasonJoined: 5 },
};
...
export const SEED: Record<ChannelId, ChatMessage[]> = {
  global: [
    ...
    M('g2', 'Corvin', 'prata', 'acabei de desbloquear o Celeiro, tô empolgado kkk', '13:53'),
    M('g3', 'Aldric', 'ouro', 'já chegou no Império? tô juntando trigo faz um tempão', '13:54'),
    M('g4', 'Mirena', 'platina', 'cheguei ontem, o salto de custo do Reino pro Império é brutal', '13:55'),
    MEN('g4b', 'Kaelen', 'diamante', '@Você teu reino tá voando, bora um coop depois?', '13:55'),
    M('g5', 'Petra', 'platina', 'nem me fala, o ciclo do Império é lento demais', '13:55'),
    ...
    M('g24', 'Mirena', 'platina', 'uns 2 dias no automático até fechar no gerador Dinastia', '14:08'),
    ...
    M('g29', 'Doran', 'bronze', 'o Moinho custando 25 de trigo tá pesado pra mim ainda', '14:13'),
    M('g30', 'Yseult', 'mestre', '@Doran no começo é assim, depois que o Camponês empilha destrava', '14:13'),
    M('g31', 'Kaelen', 'diamante', 'e deixa rodando no automático, ajuda a pegar o jeito da economia', '14:14'),
    M('g32', 'Mirena', 'platina', 'verdade, empilhar o gerador certo faz o trigo render bem mais', '14:14'),
  ...
  rank: [
    ...
    M('r7', 'Kaelen', 'diamante', 'meu trigo/s explodiu quando empilhei as Províncias', '14:01'),
  ...
  cla: [
    M('c1', 'Corvin', 'prata', 'meta do clã essa semana: todo mundo no Feudo', '13:50'),
    M('c2', 'Aldric', 'ouro', 'boa meta, quem tá longe ainda?', '13:51'),
    SYS('c3', '13:52', 'chat.sys.joined', { name: 'Doran' }),
    M('c4', 'Doran', 'bronze', 'eu tô só na Fazenda ainda kk mas deixo no automático', '13:52'),
    M('c5', 'Mirena', 'platina', '@Doran relaxa, empilha a Fazenda que o trigo vem rápido', '13:53'),
...
export const DM_SEED: Record<string, ChatMessage[]> = {
  Yseult: [
    ...
    M('dy3', 'Yseult', 'mestre', 'valeu! empilha os Feudos que teu trigo/s dispara', '14:07'),
  ...
  Mirena: [
    ...
    ME('dm2', 'bora, tô quase no Feudo', '13:49'),
