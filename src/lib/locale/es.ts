...
export const es: Dict = {
  ...
  'mode.hintAuto':
    'El juego compra solo el generador de mayor nivel que puedas pagar e investiga mejoras con lo que sobre.',
  ...
  'upg.val.cycle': 'ciclo {from} → {to}',
  'upg.val.production': '+{from} → +{to} / ciclo',
  'upg.val.cost': 'precio {from} → {to}',
  'upg.val.bonus': 'prob. {from}% → {to}%',
  'upg.val.bonusMax': 'prob. 100%',
  'upg.val.bonusAmount': 'volumen {from}% → {to}%',
  'upg.valG.cycle': 'velocidad ×{from} → ×{to}',
  ...
  'upg.cycle.hint': 'Reduce el tiempo de ciclo actual un 10% por nivel.',
  ...
  'upg.bonus.hint': 'Aumenta la probabilidad de recurso bonus un 1% por nivel, hasta 100%.',
  ...
  'reino.catchup.title': 'Actualizando el reino',
  'reino.catchup.hint': 'Procesando {time} de progreso offline…',
